...
func estimatedFlightPositionFunction(flight: Flight) -> (CFAbsoluteTime) -> CLLocation {
    ...
    func functionToReturn(currentTime: CFAbsoluteTime) -> CLLocation {
        ...
        return estimatedPosition(startingLocation: flight.startingAirportLocation, endingLocation: flight.endingAirportLocation, startTime: flight.startTime, duration: flight.duration, currentTime: currentTime)
    }
